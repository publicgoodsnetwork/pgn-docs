...
<Callout type="info">
PGN Safe multisig contracts are not fully deployed yet. We will make sure to keep this page and our [X (Twitter)](https://twitter.com/pgn_eth) account updated with our progress. 

In the meantime Metamask is the smoothest wallet experience until a full UI is deployed.
</Callout>
