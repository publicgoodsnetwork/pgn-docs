...
<Callout type="info">
There is currently no UI for deploying a Safe on PGN. We are in the process of getting PGN as an added network for the Safe UI. However, you can still deploy a Safe on PGN via the Safe contracts. Checkout the [Safe documentation](https://docs.safe.global/getting-started/readme) for how to do this.
</Callout>
...
| DAI                | 0x997cf63ab30BA8e591203228d5c5468Fc3834166 |
